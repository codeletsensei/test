...
function updateInfoDisplay(charId, idInject, charData) {
    ...
    console.log(charData.Name, parseInt(charId), bondgear_characters.includes(parseInt(charId)))
    if ( bondgear_characters.includes(parseInt(charId)) && charData.current?.bondgear > 0) {
